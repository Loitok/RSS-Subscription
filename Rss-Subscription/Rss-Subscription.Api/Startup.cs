...
using Rss_Subscription.BLL.Mappings;
using Rss_Subscription.BLL.Services.Abstractions;
using Rss_Subscription.BLL.Services.Implementations;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("ConnStr"),
                b => b.MigrationsAssembly("Rss-Subscription.DataAccess")));


            services.AddScoped<IRssSubscriptionService, RssSubscriptionService>();
